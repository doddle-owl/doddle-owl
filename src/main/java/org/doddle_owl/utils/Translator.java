...
public class Translator {
			...
			if (ins == null) {
				if (isSystemLanguage(lang)) {
					ins = Utils.class.getClassLoader().getResourceAsStream(
							Utils.RESOURCE_DIR + "DODDLE_" + lang + ".properties");
				} else {
					ins = Utils.class.getClassLoader().getResourceAsStream(
							Utils.RESOURCE_DIR + "DODDLE_" + getSystemLanguage() + ".properties");
				}
			}
	...
	public static void loadDODDLEComponentOntology(String lang) {
		...
		uriDescriptionMap = new HashMap<String, String>();
		try {
			...
			if (componentOntFile.exists()) {
				...
				InputStream ins = Utils.class.getClassLoader().getResourceAsStream(
						Utils.RESOURCE_DIR + "DODDLEComponent.owl");
