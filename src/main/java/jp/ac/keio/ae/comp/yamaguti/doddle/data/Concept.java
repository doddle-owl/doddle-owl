...
public class Concept implements Serializable {
    ...
    public void addLabel(DODDLELiteral labelLiteral) {
        if (labelLiteral.getString().length() == 0) { return; }
    ...
    public void addDescription(DODDLELiteral descriptionLiteral) {
        if (descriptionLiteral.getString().length() == 0) { return; }
    ...
    public String getWord() {
        if (inputLabel != null && 0 < inputLabel.getString().length()) { return inputLabel.getString(); }
        List<DODDLELiteral> literalList = langLabelListMap.get(DODDLEConstants.LANG);
        if (literalList != null && 0 < literalList.size()) { return literalList.get(0).getString(); }
    ...
    public String getQName() {
        if (DODDLE.getCurrentProject() == null) { return getLocalName(); }
