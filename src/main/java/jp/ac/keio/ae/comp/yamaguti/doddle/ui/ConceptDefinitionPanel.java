...
public class ConceptDefinitionPanel extends JPanel implements ListSelectionListener {
    ...
    public ConceptDefinitionPanel(DODDLEProject project) {
        ...
        mainViews[0] = new View(Translator.getTerm("WordSpaceParameterPanel"), null, algorithmPanel
                .getWordSpaceParamPanel());
        mainViews[1] = new View(Translator.getTerm("AprioriParameterPanel"), null, algorithmPanel
                .getAprioriParamPanel());
        mainViews[2] = new View(Translator.getTerm("InputConceptList"), null, resultPanel.getInputConceptPanel());
        mainViews[3] = new View(Translator.getTerm("InputDocumentList"), null, resultPanel.getInputDocPanel());
        ...
        mainViews[7] = new View(Translator.getTerm("CorrectConceptPairTable"), null, resultPanel.getAcceptedPairPanel());
        mainViews[8] = new View(Translator.getTerm("WrongConceptPairTable"), null, resultPanel.getWrongPairPanel());
    ...
    public List<String> getInputTermList() {
        ...
        if (wordCorrespondConceptSetMap != null) {
            ...
            compoundWordConceptMap = doddleProject.getConstructClassPanel().getCompoundWordConceptMap();
            Set<InputTermModel> inputWordModelSet = inputConceptSelectionPanel.getInputTermModelSet();
            for (InputTermModel iwModel : inputWordModelSet) {
                if (!iwModel.isSystemAdded()) {
                    inputTermList.add(iwModel.getTerm());
                }
            }
            DefaultListModel undefinedTermListModel = inputConceptSelectionPanel.getUndefinedTermListPanel().getModel();
