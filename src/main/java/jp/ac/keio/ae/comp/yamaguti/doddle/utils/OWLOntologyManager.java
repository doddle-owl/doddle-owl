...
public class OWLOntologyManager {
    ...
    public static void addRefOntology(File ontFile) {
        try {
            ...
            Model ontModel = Utils
                    .getOntModel(new FileInputStream(ontFile), "---", "RDF/XML", DODDLEConstants.BASE_URI);
            ReferenceOWLOntology refOnt = new ReferenceOWLOntology(ontModel, uri, new NameSpaceTable());
