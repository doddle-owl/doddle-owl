 ...
 */
public class SwoogleWebServiceWrapperPanel extends JPanel implements ActionListener, ListSelectionListener {
    ...
    public SwoogleWebServiceWrapperPanel(NameSpaceTable nsTable, OWLOntologySelectionPanel owlPanel) {
        ...
        inputWordAreaScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("InputWordListArea")));
        ...
        classJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("ClassList")));
        ...
        propertyJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("PropertyList")));
        ...
        domainJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("DomainList")));
        rangeJList = new JList();
        JScrollPane rangeJListScroll = new JScrollPane(rangeJList);
        rangeJListScroll.setBorder(BorderFactory.createTitledBorder(Translator.getTerm("RangeList")));
    ...
    public void valueChanged(ListSelectionEvent e) {
        ReferenceOWLOntology refOnto = (ReferenceOWLOntology) acquiredOntologyJList.getSelectedValue();
        if (refOnto == null) { return; }
