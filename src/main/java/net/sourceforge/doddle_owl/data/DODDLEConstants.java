...
public class DODDLEConstants {
    ...
    public static final String LAST_UPDATE = "2015-03-21";
    ...
    public static String BASE_URI = "http://doddle-owl.sourceforge.net#";
    public static final String DODDLE_URI = "http://doddle-owl.sourceforge.net#";
