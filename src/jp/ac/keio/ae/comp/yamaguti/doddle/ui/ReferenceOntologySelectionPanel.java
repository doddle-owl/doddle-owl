...
public class ReferenceOntologySelectionPanel extends JPanel implements ActionListener {
    ...
    public ReferenceOntologySelectionPanel() {
        ...
        mainViews[1] = new View(Translator.getTerm("OWLOntologySelectionPanel"), null, owlOntologySelectionPanel);
    ...
    public void actionPerformed(ActionEvent e) {
        DODDLE.setSelectedIndex(DODDLEConstants.INPUT_DOCUMENT_SELECTION_PANEL);
    }
